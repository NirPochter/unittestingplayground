...
class NewVisiterTest(LiveServerTestCase):
	...
	def test_can_start_a_list_and_retrieve_it_later(self):
		...
		#Upon hitting enter, she is taken to a new URL., and the page updates and lists the first 
		#todo item in the list.
		...
		# User visits webpage, TODO list of old user is not shown.
		self.browser.get(self.live_server_url)
